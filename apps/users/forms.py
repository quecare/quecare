...
class UserLoginForm(Form):
    ...
    def validate(self):
        ...
        physician = mongo.db.Physicians.find_one(
...
class UserRegistrationForm(Form):
    ...
    def validate(self):
        ...
        if mongo.db.Physicians.find_one({'email': self.email.data}):
            self.email.errors.append('Email has been registered')
            return False

        if mongo.db.Physicians.find_one({'username': self.username.data}):
